# ARMarketer — Web VR/AR Marketing Platform 開發計劃書

本專案旨在建置自有 Web AR/VR/3D Marketing Platform，取代既有 Zapworks 訂閱服務。專案以手機 Web AR 為核心，優先解決模型載入與品質問題。

## 詳細規劃文件
所有開發細節與進度規劃，請參閱 `docs/plan/` 目錄下的以下文件：
...
---
## 聯絡與支援
如有關於本專案架構與開發的任何問題，請優先閱讀 `docs/plan/` 目錄內的檔案。
